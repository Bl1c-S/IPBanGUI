...
namespace WPF_IPBanUtility.Properties {
    ...
    public class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to У вікні є не збережені ключі, зберегти зміни?
        ///
        ///Для застосування змін служба IPBan буде перезавантажена після закриття вікна..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Не оброблена помилка в додатку.
        /// </summary>
